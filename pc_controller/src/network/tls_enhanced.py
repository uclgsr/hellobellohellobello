...
class SecureConnectionManager:
    ...
    def wrap_server_socket(self, sock: socket.socket, server_hostname: Optional[str] = None) -> Union[socket.socket, ssl.SSLSocket]:
    ...
    def wrap_client_socket(self, sock: socket.socket, server_hostname: Optional[str] = None) -> Union[socket.socket, ssl.SSLSocket]:
    ...
    def connect_secure(self, host: str, port: int, timeout: float = 10.0) -> Union[socket.socket, ssl.SSLSocket]:
...
class SecureMessageHandler:
    ...
    def send_secure_message(self, sock: Union[socket.socket, ssl.SSLSocket], message: bytes) -> bool:
    ...
    def receive_secure_message(self, sock: Union[socket.socket, ssl.SSLSocket], timeout: float = 10.0) -> Optional[bytes]:
    ...
    def _receive_exactly(self, sock: Union[socket.socket, ssl.SSLSocket], num_bytes: int) -> Optional[bytes]:
