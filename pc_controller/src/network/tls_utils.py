...
def create_client_ssl_context() -> ssl.SSLContext | None:
    ...
    # If no CA is provided, still allow system CAs; if absolutely no CA and CERT_REQUIRED would fail,
    # tests should keep TLS disabled. Here we stick to CERT_REQUIRED assuming CA is present when enabled.
