...
class HeartbeatManager:
    ...
    def record_heartbeat(self, device_id: str, metadata: Optional[Dict[str, Any]] = None) -> None:
    ...
    def get_device_status(self, device_id: str) -> Optional[HeartbeatStatus]:
    ...
    def create_heartbeat_message(self, device_id: str, metadata: Optional[Dict[str, Any]] = None) -> str:
    ...
    def parse_heartbeat_message(self, message: str) -> Optional[Dict[str, Any]]:
