...
class ErrorMessageTranslator:
    ...
    ERROR_TRANSLATIONS: Dict[str, str] = {
        # Network errors
        "ConnectionRefusedError": "Unable to connect to device. Please check that the device is on the same WiFi network and try again.",
        "TimeoutError": "Connection timed out. Please check your network connection and ensure the device is responding.",
        "ConnectionResetError": "Connection was lost unexpectedly. The device may have restarted or lost network connectivity.",
        "NetworkUnreachableError": "Network is unreachable. Please check your WiFi connection and try again.",
        
        # File system errors
        "FileNotFoundError": "Required file could not be found. Please check that all files are in the correct location.",
        "PermissionError": "Permission denied. Please check file permissions or run as administrator if needed.",
        "DiskSpaceError": "Insufficient disk space. Please free up storage space and try again.",
        "FileExistsError": "A file with this name already exists. Please choose a different name or location.",
        
        # Device errors
        "DeviceNotFoundError": "Device not detected. Please ensure the device is connected and powered on.",
        "DeviceBusyError": "Device is currently busy or being used by another application. Please close other applications and try again.",
        "DeviceDisconnectedError": "Device was disconnected during operation. Please reconnect the device and try again.",
    ...
    @classmethod
    def translate_error(cls, error: Exception, context: Optional[str] = None) -> str:
        """
    ...
    @classmethod
    def log_user_friendly_error(cls, error: Exception, context: Optional[str] = None, 
...
def show_user_friendly_error(error: Exception, context: Optional[str] = None) -> str:
