    ...
    def _create_tutorial_steps(self) -> List[TutorialStep]:
        ...
        return [
            ...
            TutorialStep(
                ...
                <ol>
                <li><b>WiFi Network:</b> Ensure your PC and Android devices are on the same WiFi network</li>
                <li><b>Automatic Discovery:</b> Android devices will automatically discover this PC Hub</li>
                <li><b>Manual Connection:</b> If automatic discovery fails, use the "Connect Device" button</li>
                </ol>
                
                <div style='background-color: #e8f4f8; padding: 10px; border-radius: 5px; margin-top: 10px;'>
                <b>Troubleshooting:</b> If devices don't appear, check your firewall settings and ensure both devices have internet access.
                </div>
                """,
            ...
            TutorialStep(
                ...
                <p><b>Camera Calibration:</b> For best results, calibrate your cameras before recording:</p>
                <ol>
            ...
            TutorialStep(
                ...
                <li><b>Monitor Devices:</b> Watch the device status indicators for connection health</li>
                <li><b>Flash Sync:</b> Use "Flash Sync" to synchronize timestamps across devices</li>
                <li><b>Stop Session:</b> Click "Stop Session" when finished</li>
                </ol>
                
                <div style='background-color: #f0f8e8; padding: 10px; border-radius: 5px; margin-top: 10px;'>
                <b>Best Practice:</b> Start with short test sessions (1-2 minutes) to verify everything works before longer recordings.
                </div>
                """,
            ...
            TutorialStep(
                ...
                <div style='background-color: #f8f0e8; padding: 10px; border-radius: 5px; margin-top: 10px;'>
                <b>File Locations:</b> Export locations are clearly shown in the log and status messages.
                </div>
                """,
            ...
            TutorialStep(
                ...
                <tr style='background-color: #f9f9f9;'>
                    ...
                    <td style='padding: 8px; border: 1px solid #ddd;'>Toolbar → "Connect Device"</td>
                </tr>
                <tr>
                    <td style='padding: 8px; border: 1px solid #ddd;'>Calibrate Cameras</td>
                    <td style='padding: 8px; border: 1px solid #ddd;'>Toolbar → "Calibrate Cameras"</td>
                </tr>
                <tr style='background-color: #f9f9f9;'>
                ...
                <p style='margin-top: 15px;'><b>Need Help?</b> Check the logs tab for detailed status messages and troubleshooting information.</p>
                """,
                skip_allowed=False
            )
        ]
