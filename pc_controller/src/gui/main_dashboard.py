...
from PyQt6.QtWidgets import (
    ...
    QLineEdit, QTextEdit, QGroupBox, QProgressBar, QComboBox,
    QStatusBar, QSplitter, QFrame, QScrollArea, QGridLayout
)
...
class DeviceWidget(QFrame):
    ...
    def setup_ui(self):
        ...
        info_layout.addWidget(QLabel(f"{self.device_status.ip_address}:{self.device_status.port}"), 0, 1)
...
class SessionControlWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.start_session_btn.setStyleSheet("QPushButton { background-color: green; color: white; font-weight: bold; }")
        control_layout.addWidget(self.start_session_btn)
        
        self.stop_session_btn = QPushButton("Stop Session")
        self.stop_session_btn.setStyleSheet("QPushButton { background-color: red; color: white; font-weight: bold; }")
        ...
        self.flash_all_btn.setStyleSheet("QPushButton { background-color: orange; color: white; font-weight: bold; }")
...
class MainDashboard(QMainWindow):
    ...
    def setup_session_tab(self):
        ...
        self.session_table.setHorizontalHeaderLabels(["Session ID", "Start Time", "Duration", "Devices"])
    ...
    def update_dashboard(self):
        ...
        online_count = sum(1 for d in self.devices.values() if d.connection_state == 'online')
