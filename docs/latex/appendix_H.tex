...
Python Controller (`/pc_controller/`):
...
Android Application (`/android_sensor_node/`):
...
- \textbf{Python Controller}: `pc_controller/src/gui/gui_manager.py` (487 lines) \cite{ref17}
- \textbf{Android App}: `android_sensor_node/app/src/main/` (Kotlin implementation)
...
python pc_controller/test_sync_accuracy.py
