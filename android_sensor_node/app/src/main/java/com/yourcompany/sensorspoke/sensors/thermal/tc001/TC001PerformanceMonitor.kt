 ...
 */
class TC001PerformanceMonitor(private val context: Context) {
    ...
    private fun updatePerformanceMetrics() {
        ...
        val avgLatency = processingLatencies.toList().let { latencies ->
        ...
        val metrics = TC001PerformanceMetrics(
            frameRate = frameRate,
    ...
    private fun assessConnectionQuality(): Double {
        val frameRate = calculateFrameRate()
        val avgLatency = processingLatencies.toList().let { 
    ...
    private fun checkPerformanceAlerts() {
        ...
        if (frameRate < ALERT_THRESHOLD_LOW_FPS) {
            alerts.add(TC001PerformanceAlert(
    ...
    private fun assessSystemHealth() {
        ...
        val systemHealth = TC001SystemHealth(
            status = health,
            frameRate = frameRate,
