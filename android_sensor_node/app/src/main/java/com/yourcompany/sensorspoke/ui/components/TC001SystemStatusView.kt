 ...
 */
class TC001SystemStatusView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        // System status
        systemStatusText = TextView(context).apply {
        ...
        // Data processing status
        dataProcessingStatusText = TextView(context).apply {
        ...
        // Temperature status
        temperatureStatusText = TextView(context).apply {
        ...
        systemHealthIndicator = TextView(context).apply {
            text = "● System Status"
     ...
     */
    fun updateSystemStatus(state: TC001IntegrationState, statusMessage: String) {
        systemStatusText.text = "TC001 System: $statusMessage"
        
        val (color, healthIndicator) = when (state) {
     ...
     */
    fun updateConnectionStatus(isConnected: Boolean, deviceName: String = "TC001") {
     ...
     */
    fun updateDataProcessingStatus(isProcessing: Boolean, frameRate: Int = 0) {
     ...
     */
    fun updateTemperatureStatus(temp: Float?, unit: String = "°C") {
